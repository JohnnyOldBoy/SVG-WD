...
var mouseDownP = document.documentElement.createSVGPoint();
...
{ 
    ...
    if(target) {
        ...
        p.x = evt.clientX;
        p.y = evt.clientY;
	mouseDownP.x = evt.clientX;
        mouseDownP.y = evt.clientY;
...
function rotateLeft()
{
	var svgDoc = window.parent.document.svgimg.getSVGDocument();
	var childSVGs = svgDoc.getElementsByTagName("g");
